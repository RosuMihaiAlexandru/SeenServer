...
module.exports = async function (request, reply) {
    ...
    await User.findOne({ email: sendTo }).then(
        ...
        if(user){
            ...
            '<div style="margin-top:37px; border-radius:30px;padding:15px 30px;color:#ffffff;font-family:Montserrat,Arial,sans-serif;font-size:14px;line-height:18px;text-align:center;letter-spacing:2px;text-transform:uppercase; background-color:#085078"> <a href="https://theseenapp.com/reset-password"' + ' rel="noopener noreferrer" style="color:#ffffff;text-decoration:none" target="_blank"><span style="color:#ffffff;text-decoration:none">RESET PASSWORD</span></a> </div>' +
